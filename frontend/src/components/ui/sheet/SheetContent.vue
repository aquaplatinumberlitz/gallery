...
<template>
  <DialogPortal>
    <DialogOverlay
      class="fixed inset-0 z-[var(--gallery-z-modal)] bg-black/60 backdrop-blur-[2px] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0"
    />
