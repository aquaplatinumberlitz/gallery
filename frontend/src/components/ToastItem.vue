...
<template>
  ...
  >
    ...
    <div class="toast__content">
      ...
      <div v-if="toast.message && toast.html" class="toast__message" v-html="toast.message" />
      <div v-else-if="toast.message" class="toast__message">
        {{ toast.message }}
      </div>
    ...
    <div v-if="toast.duration && toast.duration > 0" class="toast__progress">
      <div class="toast__progress-bar" :style="{ width: `${progress}%` }" />
    </div>
  </div>
</template>
