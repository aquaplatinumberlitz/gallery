...
<template>
  <div class="mobile-bottom-bar-layer" :class="{ hidden: !barsVisible }">
...
.mobile-bottom-bar-layer.hidden {
  pointer-events: none;
}

.mobile-bottom-bar-layer.hidden .mobile-bottom-bar {
