...
| 2026-07-13 | D6 | Complete | Managed Search V2 discovery E2E covers reload/history, saved/recent actions, prompt groups, same-node workflow predicates, raw acknowledgement, index lifecycle actions, and desktop/tablet/mobile parity; 105 backend API tests, 1,167 backend tests at 90.03% coverage, 1,109 frontend unit tests, 170 functional E2E tests, and 3 performance tests passed, with the 5,000-row search p95 at 227.48 ms against the 300 ms budget. |
