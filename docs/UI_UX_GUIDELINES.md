...
- Render indexed facet values and counts as wrapping items instead of a truncated sentence. Show complete short groups immediately and use an explicit Show more/Show less control for long groups.
