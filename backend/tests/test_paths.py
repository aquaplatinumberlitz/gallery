...
* is_path_safe returns True for GALLERY_ROOT itself and children under it.
* is_path_safe returns False for paths outside GALLERY_ROOT.
...
* changing gallery root containment logic
"""
...
class TestIsPathSafe:
    def test_exact_gallery_root_allowed(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch):
        monkeypatch.setattr("backend.paths.GALLERY_ROOT", tmp_path)
