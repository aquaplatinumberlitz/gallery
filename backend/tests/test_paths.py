...
Guarantees:
* resolve_path normalizes resolution failures into InvalidPathError.
...
from backend.paths import InvalidPathError, is_path_safe, resolve_path


class TestResolvePath:
    def test_raises_invalid_path_on_non_windows(self, monkeypatch: pytest.MonkeyPatch):
    ...
    def test_windows_extended_path_fallback(self, monkeypatch: pytest.MonkeyPatch):
        ...
        with suppress(InvalidPathError):
