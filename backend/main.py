...
# CACHE CONFIGURATION
# =============================================================================
# Thumbnail cache: persistent disk-backed cache (stores WebP bytes)
# Metadata cache: in-memory LRU cache (stores dict objects)
METADATA_CACHE_MAX_BYTES = 100 * 1024 * 1024         # 100 MB

# Persistent thumbnail cache survives backend restarts.
